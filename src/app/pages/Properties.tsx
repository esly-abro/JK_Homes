...
import { Building2, Plus, Search, Filter, Edit2, Trash2, MapPin, DollarSign, Home, Users } from 'lucide-react';
import { Button } from '../components/ui/button';
import { Input } from '../components/ui/input';
import { Label } from '../components/ui/label';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogFooter } from '../components/ui/dialog';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '../components/ui/select';
import { getProperties, createProperty, updateProperty, deleteProperty, Property } from '../../services/properties';
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ 
                    ...formData, 
                    price: { ...formData.price!, min: parseInt(e.target.value) || 0 }
                  })}
                  placeholder="5000000"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="maxPrice"
                  type="number"
                  value={formData.price?.max || 0}
                  onChange={(e) => setFormData({ 
                    ...formData, 
                    price: { ...formData.price!, max: parseInt(e.target.value) || 0 }
                  })}
                  placeholder="8000000"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  id="size"
                  type="number"
                  value={formData.size?.value || 0}
                  onChange={(e) => setFormData({ 
                    ...formData, 
                    size: { ...formData.size!, value: parseInt(e.target.value) || 0 }
                  })}
                  placeholder="2000"
                />
              </div>
